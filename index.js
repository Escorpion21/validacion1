...
const getIp = async () => {
    try{
        const response = await fetch("https://api.geoapify.com/v1/ipinfo?apiKey=f2bd32dceccd400ca840bd0fd39bbf2e")
...
{ 
    const elementIsoCode = element.getAttribute("data-countrycode")
